...
The importmap is configured by setting the key "importmap" at the page-attribute
within your site sets configuration in your settings.yaml file:
...
file into your extensions Public/JavaScript/ folder. After that you reference it in your settings.yaml:
...
Now you could import the stimulus JS module with this command while keeping the YAML more
